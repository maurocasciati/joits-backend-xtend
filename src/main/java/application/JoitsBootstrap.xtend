...
class JoitsBootstrap extends CollectionBasedBootstrap {
	...
	def agregarEntradasAUsuarios() {
		...
		var entrada9 = new Entrada("Volver al futuro II")
		var entrada10 = new Entrada("Duro de matar")
		var entrada11 = new Entrada("War Games")
		var entrada12 = new Entrada("El día de la marmota")
		var entrada13 = new Entrada("Duro de matar")
		var entrada14 = new Entrada("Volver al futuro II")
		var entrada15 = new Entrada("Pulp Fiction")
		var entrada16 = new Entrada("Saga Volver al futuro")
